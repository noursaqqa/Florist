...
class CardItem extends React.Component {
  ...
  render() {
    ...
    var cardUrl =
      "https://quiet-garden-49547.herokuapp.com/?id=" +
      `${this.props.card._id}`;
    return (
          ...
          <div className="card-actions">
            <span className="card-delivery">
              <span className="truck-icon">
                <img
                  src="https://image.flaticon.com/icons/png/512/39/39866.png"
                  alt="truck icon"
                />
              </span>
            ...
            <span className="card-favButton">
              <img
                src="https://cdn3.iconfinder.com/data/icons/complete-set-icons/512/favourite512x512.png"
                alt="fav button"
              />
            </span>
          </div>
